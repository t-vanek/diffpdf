        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    trigger_source = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    trigger_config_json = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    comparer_source = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    comparison_options_json = table.Column<string>(type: "nvarchar(max)", nullable: false),
