...
/// <summary>EF Core (PostgreSQL) schedule store — runtime-managed recurring batch definitions.</summary>
public sealed class PostgresScheduleStore(DiffPdfDbContext db, EntityMapper mapper) : IScheduleStore
{
