...
/// <summary>EF Core (PostgreSQL) trigger store — soft delete + optimistic concurrency + single default per instance.</summary>
public sealed class PostgresTriggerStore(DiffPdfDbContext db, EntityMapper mapper) : ITriggerStore
{
