...
/// <summary>EF Core (PostgreSQL) API key store — unique hash + soft delete + optimistic concurrency.</summary>
public sealed class PostgresApiKeyStore(DiffPdfDbContext db, EntityMapper mapper) : IApiKeyStore
{
