...
/// <summary>EF Core (PostgreSQL) per-scope configuration store (triggers + comparers, one row per scope).</summary>
public sealed class PostgresScopeConfigurationStore(DiffPdfDbContext db, EntityMapper mapper) : IScopeConfigurationStore
{
